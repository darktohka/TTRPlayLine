package com.denialmc.ttrplayline.http;
...
public abstract class NanoHTTPD {
    ...
    public static class Response {
        ...
        /**
         * New constructor: response = HTTP_OK, mime from extension and message = supplied
         */
        public Response(String msg, String extension) {
        	this(Status.OK, getMime(extension), msg);
        }
    ...
    public static final class ResponseException extends Exception {
		...
		private static final long serialVersionUID = -3942087534431486094L;
